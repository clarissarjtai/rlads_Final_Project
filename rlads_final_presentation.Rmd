...
```
從此圖可以看出美國的股市只有在疫情初期受到劇烈的影響，疫情中期之後無論確診病例數為何，基本上標普500指數都是穩定上升。
...
```
從該圖表中可以看出，2020年11月以前的每日確診數與與類股指數波動都有一定的相關性，12月到1月這段期間的RMSE明顯提高，顯示出在這段期間類股指數的變動率遠大於確診數。也就是說[美國新增確診數從1月逐漸下降](https://www.nytimes.com/interactive/2021/us/covid-cases.html)，但是下降幅度不及各大類股上升的幅度。以下取出在2020年12月至2021年1月之間，RMSE波動最大的兩個產業類股與波動最小的兩個類股進行分析：

* RMSE波動較大：
  + 醫療保健類股指數(Health Care)
    + 美國於12月分別給予輝瑞疫苗與莫德納疫苗緊急使用授權，使得醫療保健類股指數在這段期間指數大幅上漲。
    [BBC中文網：新冠疫苗開打，你應當知道的幾大問題](https://www.bbc.com/zhongwen/trad/science-55332811)
  + 能源類股(Energy)
    + 燃油佔能源產業大宗，國際旅行的大幅減少使得美國對於能源的需求下降。
    ...
    + 從12月中下旬開始出入境的旅客數開始恢復穩定在百萬人次以上，間接解釋能源類股大幅上升的原因。
...
* RMSE波動較小：
  ...
  + 必須性消費品(Consumer Staples)
    + 民生必需品並不會因為疫情的嚴重與疫情相關的政策而有太大的的改變。
